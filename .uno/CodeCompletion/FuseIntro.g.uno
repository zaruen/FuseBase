public partial class FuseIntro: Fuse.Controls.Panel
{
    public partial class Template: Uno.UX.Template<Fuse.Controls.Text>
    {
        internal readonly FuseIntro __parent;
        public Template(FuseIntro parent)
        {
            __parent = parent;
        }
        static Template()
    ...
    {
        internal readonly FuseIntro __parent;
        public Template1(FuseIntro parent)
        {
            __parent = parent;
        }
        static Template1()
    ...
    {
        internal readonly FuseIntro __parent;
        public Template2(FuseIntro parent)
        {
            __parent = parent;
        }
        static Template2()
    ...
    {
        internal readonly FuseIntro __parent;
        public Factory(FuseIntro parent): base(null, false)
        {
            __parent = parent;
        }
        MyBaseApp_FuseDrawingSolidColor_float4_Color_Property color_Color_inst;
        ...
        public override object New()
        {
            ...
            color_Color_inst = new MyBaseApp_FuseDrawingSolidColor_float4_Color_Property(color);
    ...
    MyBaseApp_FuseTriggersWhileBool_bool_Value_Property canSwipe_Value_inst;
    MyBaseApp_FuseiOSStatusBarConfig_UnoPlatformiOSStatusBarStyle_Style_Property statusBarConfig_Style_inst;
    MyBaseApp_FuseEffectsBlur_float_Radius_Property blur_Radius_inst;
    ...
    internal void InitializeUX()
    {
        ...
        canSwipe_Value_inst = new MyBaseApp_FuseTriggersWhileBool_bool_Value_Property(canSwipe);
        statusBarConfig = new Fuse.iOS.StatusBarConfig();
        statusBarConfig_Style_inst = new MyBaseApp_FuseiOSStatusBarConfig_UnoPlatformiOSStatusBarStyle_Style_Property(statusBarConfig);
        blur = new Fuse.Effects.Blur();
        blur_Radius_inst = new MyBaseApp_FuseEffectsBlur_float_Radius_Property(blur);
